...
class PlatesController {
    ...
    async updatePlate(request, response) {
        const { plate_id, plate_title, plate_description, plate_price } = request.body
    ...
    async createPlate(request, response) {
        const { plate_title, plate_description, plate_price, ingredient_list } = request.body
    ...
    async uploadPicture(request, response) {
        const { plate_id } = request.params
        const plate_picture = request.body.plate_picture
